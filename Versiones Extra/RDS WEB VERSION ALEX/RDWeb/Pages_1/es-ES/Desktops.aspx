...
<script runat="server">
    ...
    const string L_SignOutTab_Text = "Cerrar sesión";
    const string L_HelpTab_Text = "Ayuda";
    const string L_DesktopHeader_Text = "Conexión web a Escritorio remoto de los Servicios de Escritorio remoto";
    const string L_DesktopDesc_Text = "Escriba el nombre del equipo remoto al que desea conectarse, especifique opciones y haga clic en Conectar.";
    const string L_Options_Text = "<u>O</u>pciones";
    const string L_ConnectionOptionsHeader_Text = "Opciones de conexión";
    const string L_RemoteDesktopSize_Text = "<u>T</u>amaño del escritorio remoto:";
    const string L_FullScreenLabel_Text = "Pantalla completa";
    const string L_800x600Label_Text = "800 x 600 píxeles";
    const string L_1024x768Label_Text = "1024 x 768 píxeles";
    const string L_1280x1024Label_Text = "1280 x 1024 píxeles";
    const string L_1600x1200Label_Text = "1600 x 1200 píxeles";
    ...
    const string L_ResolutionAccessKey_Text = "t";
    const string L_Resolution_Text="<u>T</u>amaño del escritorio remoto:";
    const string L_OptionsAccessKey_Text = "o";
    const string L_ConnectAccessKey_Text = "n";
    const string L_DevAndRes_Text = "Dispositivos y recursos";
    const string L_DevAndResDesc_Text = "Seleccione los dispositivos y recursos que desee usar en la sesión remota.";
    const string L_PrinterLabel_Text = "<u>I</u>mpresoras";
    const string L_ClipboardLabel_Text = "<u>E</u>scritorio";
    const string L_DrivesLabel_Text = "<u>U</u>nidades";
    const string L_PNPLabel_Text = "Dispositivos Plu<u>g</u> and Play compatibles";
    const string L_SerialLabel_Text = "<u>P</u>uertos especiales";
    const string L_PrinterRedirectionAccessKey_Text = "i";
    const string L_ClipboardAccessKey_Text = "e";
    const string L_DrivesAccessKey_Text = "u";
    const string L_PNPAccessKey_Text="g";
    const string L_SerialAccessKey_Text="p";
    const string L_AdditionalOptions_Text = "Opciones adicionales";
    const string L_SoundLabel_Text = "Sonido de e<u>q</u>uipo remoto:";
    const string L_SoundToComputerLabel_Text = "Traer a este equipo";
    const string L_SoundDisabledLabel_Text = "No reproducir";
    const string L_SoundAtServerLabel_Text = "Dejar en el equipo remoto";
    const string L_KeyLabel_Text = "Aplicar <u>m</u>étodos abreviados de teclado:";
    const string L_KeyAtServerLabel_Text = "En el equipo remoto";
    const string L_KeyAtComputerLabel_Text = "En el equipo local";
    const string L_KeyAtServerFullScreenLabel_Text = "Solo en modo de pantalla completa";
    const string L_PerformanceLabel_Text = "<u>R</u>endimiento:";
    const string L_ModemLabel_Text = "Módem (56 Kbps)";
    const string L_LowSpeedBroadbandLabel_Text = "Banda ancha a baja velocidad (256 Kbps - 2 Mbps)";
    const string L_SatelliteLabel_Text = "Satélite (2 - 16 Mbps con latencia alta)";
    const string L_HighSpeedBroadbandLabel_Text = "Banda ancha a alta velocidad (2 - 10 Mbps)";
    const string L_WANLabel_Text = "WAN (10 Mbps o más con latencia alta)";
    const string L_LANLabel_Text = "LAN (10 Mbps o superior)";
    const string L_AutoDetectBandWidth_Text = "Detectar calidad de conexión automáticamente";        
    const string L_KeyboardAccessKey_Text = "m";
    const string L_PerformanceAccessKey_Text = "r";
    const string L_SoundAccessKey_Text = "q";
    const string L_PrivateDesc_Text = "Si selecciona esta opción, podrá guardar sus credenciales para usarlas en un futuro cuando se conecte a estos programas. Antes de seleccionar esta opción, asegúrese de que la directiva de seguridad de su organización le permita guardar las credenciales.";
    const string L_HideInfoLabel_Text = "Ocultar información adicional...";
    const string L_MoreInfoLabel_Text = "Más información...";
    const string L_PrivateLabel_Text = "Uso un equipo privado que satisface la directiva de seguridad de mi organización.";
    const string L_InvalidMachineName_Text = "Debe escribir un nombre de equipo remoto.";
    ...
    <HTMLMainContent>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <![CDATA[
                ...
                var L_sTitle_Text = "Conexión a Escritorio remoto";
                ...
                {
                    var retval;
                    var L_errMsg_Text = "Para usar este sitio web, el equipo debe ejecutar el cliente de Conexión a Escritorio remoto (RDC). \n\nPara continuar, instale el cliente RDC y las actualizaciones más recientes desde el sitio web de Microsoft Update e inténtelo de nuevo.";
                    ...
                    {
                        var L_errMsg2_Text = "Se detectó un error de aplicación:\n\nError:%ErrorMessage%\nDirección URL:%URL%\nLínea:%ErrorLineNumber%" ; // {Placeholder="%ErrorMessage%","%URL%","%ErrorLineNumber%"}
                ...
                {
                    var L_errMsgLoad_Text = "Se detectó un problema al cargar el control ActiveX.";
    ...
    %>
                ...
                if (TestTxt(document.getElementById("MachineName"))== false)
                {
                    ...
                    catch(e)
                    {
                        ...
                        {
                            var L_ErrMsgLaunch_Text = "La configuración de seguridad del explorador impide que este sitio web de los Servicios de Escritorio remoto inicie el programa remoto. Agregue este sitio web de los Servicios de Escritorio remoto a la zona de sitios de confianza o de intranet local del explorador e inténtelo de nuevo.";
            ...
            function GetParam(sParam, bReqd, vDefault)
            {
                ...
                else
                {
                    ...
                    {
                        var L_ErrMsgInvalid_Text = "%ParameterName% no es un nombre de parámetro válido o disponible.";  // {Placeholder="%ParameterName%"}
